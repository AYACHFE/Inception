...
define( 'DB_NAME', getenv('SQL_DATABASE') ? getenv('SQL_DATABASE') : 'default_db_name' );

/** Utilisateur de la base de données MySQL. */
define( 'DB_USER', getenv('SQL_USER') ? getenv('SQL_USER') : 'default_db_name' );

/** Mot de passe de la base de données MySQL. */
define( 'DB_PASSWORD', getenv('SQL_PASSWORD') ? getenv('SQL_PASSWORD') : 'default_db_name' );
